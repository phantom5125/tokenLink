...
This firmware does not connect directly to OpenAI. TokenLink 0.2.1 builds only
...
status to the paired computer. The paired operating system and host applications
control how local input is processed. Review their privacy and security settings
separately.
