...
@Test func minimaxRegionsUseOnlyOfficialHTTPSHosts() throws {
    #expect(MiniMaxRegion.global.endpoint.absoluteString == "https://www.minimax.io/v1/token_plan/remains")
    #expect(MiniMaxRegion.china.endpoint.absoluteString == "https://platform.minimaxi.com/v1/token_plan/remains")
...
@Test func minimaxProviderUsesSelectedRegionAndBearerKey() async throws {
    let http = MiniMaxHTTPClient(response: HTTPResponse(
