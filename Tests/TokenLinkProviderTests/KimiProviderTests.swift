...
@Test func derivesKimiUsedQuotaWhenCurrentResponseOmitsUsed() throws {
  let data = Data(
    #"{"subType":"BASIC","usage":{"limit":"1000","remaining":"1000","resetTime":"2026-09-01T00:00:00Z"},"limits":[{"window":{"duration":300,"timeUnit":"TIME_UNIT_MINUTE"},"detail":{"limit":"100","remaining":"75","resetTime":"2026-08-30T12:00:00Z"}}]}"#
      .utf8)
  ...
  #expect(snapshot.windows[0].remainingPercent == 100)
  #expect(snapshot.windows[1].usedPercent == 25)
